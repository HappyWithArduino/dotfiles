...
globalkeys = gears.table.join(
    ...
    awful.key({modkey, "Shift"}, "=", function() awful.spawn.with_shell("amixer -q -D pulse set Master 15%+")end, 
        {description = "volume up", group = "audio"}),
    awful.key({modkey, "Shift"}, "-", function() awful.spawn.with_shell("amixer -q -D pulse set Master 15%-")end, 
        {description = "volume down", group = "audio"}),
    --browser control 
    ...
    --launch thunderbird
    awful.key({modkey, "Shift"}, "t", function() awful.spawn.with_shell("thunderbird")end, 
        {description = "launch thuderbird", group = "programs"}),
    --launch steam
